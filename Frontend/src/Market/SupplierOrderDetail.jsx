...
import {supplierOrderDetail as orderDetailAction} from './actions/orderActions'

const OrderDetail = () => {

    const { supplierOrderDetail, loading } = useSelector(state => state.orderState)
    const { shippingInfo={}, user={}, orderStatus="Processing", orderItems=[], totalPrice=0, paymentInfo={} } = supplierOrderDetail;
